      ...
      <div id="slider" className="flex  space-x-4 pb-4 w-full">
        ...
        >
          <div className="min-w-[480px] flex-shrink-0 flex flex-col ">
            ...
            />
            <span className=" text-black text-[25px] font-bold ml-[78.8px]">
              Office
            </span>
            <p className="w-[313.55px] text-left text-[#5A5A5A] text-[16.5px] ml-[79.89px] ">
          ...
          <div className="min-w-[480px] flex-shrink-0 flex flex-col items-center">
            ...
            />
            <span className=" text-black text-[25px] font-bold ml-[-390px]">
              Office
            </span>
            <p className="w-[313.55px] text-left text-[#5A5A5A] text-[16.5px] ml-[-160px] ">
              Home Sets, Pens, Keychains And Tools, Bags And Travel, Textile,
              Technology
            </p>
          </div>
